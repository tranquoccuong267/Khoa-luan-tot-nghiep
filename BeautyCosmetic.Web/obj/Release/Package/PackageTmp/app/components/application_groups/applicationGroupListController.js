(function (app) {
    ...
    applicationGroupListController.$inject = ['$scope', 'apiService', 'notificationService', '$window','$filter'];

    function applicationGroupListController($scope, apiService, notificationService, $window, $filter) {
        $scope.loading = true;
        $scope.data = [];
        $scope.page = 0;
        $scope.pageCount = 0;
        ...
        $scope.ShowConfirm5 = ShowConfirm5;
...
})(angular.module('BeautyCosmetic.application_groups'));
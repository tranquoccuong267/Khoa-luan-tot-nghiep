(function (app) {
    ...
    applicationRoleListController.$inject = ['$scope', 'apiService', 'notificationService', '$window', '$filter'];

    function applicationRoleListController($scope, apiService, notificationService, $window, $filter) {
        $scope.loading = true;
        $scope.data = [];
        $scope.page = 0;
        $scope.pageCount = 0;
        ...
        $scope.ShowConfirm4 = ShowConfirm4;
        $scope.deleteItem = deleteItem;
        $scope.selectAll = selectAll;
        $scope.deleteMultiple = deleteMultiple;

        function ShowConfirm4(id) {
...
})(angular.module('BeautyCosmetic.application_roles'));
...
namespace BeautyCosmetic.Web.Api
{
   ...
   // [Authorize]
    public class ProductCategoryController : ApiControllerBase
    {
        ...
        [HttpPut]
        [AllowAnonymous]
        public HttpResponseMessage UpdateById(HttpRequestMessage request, ProductCategoryViewModel productCategoryVm, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
        ...
        public HttpResponseMessage DeleteMulti(HttpRequestMessage request, string checkedProductCategories)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                else
                {
                    ...
                    {
                        var model=_productCategoryService.GetById(item);
                        model.Status = false;
                        _productCategoryService.Update(model);
                    }
